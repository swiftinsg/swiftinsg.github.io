    ...
    <>
      ...
      <Page className={styles.page}>
        ...
        <Section className={styles.sectionTwo}>
          ...
          <Text>
            <ul>
              ...
              <li>
                <b>Why did you push back the application deadline?</b> Teachers
                we spoke to at the graduation this week agreed this holiday week
                is quite busy for students (and we're guilty of adding to that,
                running 3 other ongoing competitions & challenges), so this
                extension would allow students to spend a bit more time on their
                submissions.{" "}
              </li>
              <li>
                <b>
                  My iPad PLD can't run Swift Playgrounds apps, how can I do the
                  activity required for the application?
                </b>{" "}
                Please watch{" "}
                <Link to="https://www.youtube.com/watch?v=NGBcPkwOAc0">
                  this video
                </Link>{" "}
                for a workaround.
              </li>
              <li>
                <b>
                  The application requires an iPad, and I don't have one. How?
                </b>{" "}
                If your school can loan you an iPad for 2-3 hours, you should be
                able to complete that segment in that time. Alternatively, email
                us at hello@swiftinsg.org to arrange a time to come to our
                office (at Henderson Road) to use our iPads for this activity.
              </li>
              <li>
                <b>
                ...
                We are also supporting this pilot programme hosted by Crescent
                Girls' School, which is a light introduction to prototyping and
                coding, suitable for anyone with a broad interest in design and
                app development. The Swift Accelerator Programme, on the other
                hand, goes much deeper into app development, with your own app
                as a final product. Find out more at{" "}
        ...
        <Section className={styles.sectionTwo}>
          ...
          <Text>
            <p>
              Please note, this schedule is very tentative, and based on having
              most classes conducted online — we will aim to bring together the
              class for face-to-face lessons at Apple, but only if allowed by
              prevailing safe distancing measures.
            </p>
          </Text>
          <div style={{ textAlign: "center" }}>
            <img
              className={styles.schedule}
              src="/assets/schedule2022.png"
            ></img>
            <p>
              <b>
                You may download a copy{" "}
                <Link href="https://cld.tk.sg/6quE6O6P">here</Link>
              </b>
            </p>
          </div>
        </Section>
