            ...
            <Section className={styles.sectionTwo}>
                ...
                <Text>
                    ...
                    <ol>
                        ...
                        <li>Try out Unit 1 of our <Link to="https://tk.sg/swiftui-videos-unit1">SwiftUI video series</Link>. You may use Swift Playgrounds on iPad or Mac for this. If you have any issues, email us at <Link to="mailto:hello@swiftinsg.org">hello@swiftinsg.org</Link>.</li>
